...
<section class="container mt-5">
   <h1 class="mb-4">Borrow Products</h1>
      ...
      <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
         <div class="card h-100">
            ...
            <div class="card-body">
               ...
               <a href="admin_bproducts.php?update=<?php echo $fetch_products['id']; ?>" class="btn btn-warning">Update</a>
               <a href="admin_bproducts.php?delete=<?php echo $fetch_products['id']; ?>" class="btn btn-danger" onclick="return confirm('Delete this product?');">Delete</a>
            </div>
         </div>
      </div>
      <?php
